...
const RESEARCH_CATEGORIES = [
  { id: 'automotive', label: 'Automotive', emoji: '🚗', searches: ['auto repair', 'body shop', 'oil change', 'tire shop', 'towing service', 'car wash', 'auto detailing', 'parking garage', 'car dealer', 'junkyard', 'transmission repair', 'muffler shop', 'brake repair', 'window tinting', 'car rental'] },
  { id: 'health-beauty', label: 'Health & Beauty', emoji: '💆', searches: ['dentist', 'doctor', 'chiropractor', 'optometrist', 'dermatologist', 'podiatrist', 'massage therapist', 'hair salon', 'nail salon', 'barber shop', 'spa', 'physical therapy', 'med spa', 'skincare clinic', 'cosmetic surgery'] },
  { id: 'food', label: 'Food & Beverage', emoji: '🍽️', searches: ['takeout restaurant', 'food delivery', 'breakfast and brunch', 'lunch spot', 'dinner restaurant', 'coffee and cafe', 'pizza shop', 'chinese restaurant', 'mexican restaurant', 'bakery', 'italian restaurant', 'food truck', 'sports bar', 'pub', 'ice cream shop'] },
  { id: 'home-services', label: 'Home Services', emoji: '🏡', searches: ['contractor', 'handyman', 'plumber', 'electrician', 'heating and air conditioning', 'appliance repair', 'roofing', 'locksmith', 'painter', 'landscaping', 'nursery and gardening', 'florist', 'tree service', 'house cleaning', 'furniture store', 'movers'] },
  { id: 'local-services', label: 'Local Services', emoji: '🧺', searches: ['dry cleaning', 'laundromat', 'thrift store', 'tailor and alterations', 'apartments', 'junk removal', 'parking garage', 'shoe repair', 'storage unit', 'notary'] },
  { id: 'fitness', label: 'Fitness & Gyms', emoji: '💪', searches: ['gym', 'yoga studio', 'pilates studio', 'personal trainer', 'crossfit', 'boxing gym', 'swimming pool', 'martial arts', 'dance studio', 'boot camp'] },
  { id: 'pets', label: 'Pets', emoji: '🐾', searches: ['pet groomer', 'pet store', 'veterinarian', 'dog walker', 'pet training', 'pet boarding', 'dog daycare', 'aquarium store', 'mobile pet grooming', 'pet adoption'] },
  { id: 'financial', label: 'Banks & Finance', emoji: '🏦', searches: ['bank', 'credit union', 'credit repair', 'tax preparer', 'accountant', 'insurance agent', 'mortgage broker', 'financial advisor', 'bookkeeper', 'real estate agent'] },
  { id: 'realestate', label: 'Real Estate', emoji: '🏠', searches: ['real estate agent', 'property management', 'home inspector', 'moving company', 'storage facility', 'apartments', 'pest control', 'fencing company', 'junk removal', 'cleaning service'] },
  { id: 'retail', label: 'Retail', emoji: '🛍️', searches: ['clothing store', 'boutique', 'gift shop', 'hardware store', 'electronics store', 'furniture store', 'pet store', 'jewelry store', 'thrift store', 'shoe store', 'sporting goods', 'toy store', 'home decor', 'antique shop', 'smoke shop'] },
  { id: 'tech', label: 'Tech', emoji: '💻', searches: ['IT services', 'computer repair', 'app developer', 'web hosting', 'tech startup', 'software company', 'managed IT', 'cybersecurity firm', 'digital marketing agency', 'SEO company', 'data recovery', 'phone repair', 'network setup', 'cloud services', 'tech support'] },
  { id: 'credit', label: 'Credit & Finance', emoji: '💳', searches: ['credit repair', 'tax preparer', 'accountant', 'insurance agent', 'mortgage broker', 'financial advisor', 'bookkeeper', 'payroll service', 'debt consolidation', 'loan officer', 'check cashing', 'tax attorney', 'wealth management', 'auto insurance', 'life insurance'] },
  { id: 'legal', label: 'Legal', emoji: '⚖️', searches: ['lawyer', 'personal injury attorney', 'family law', 'immigration lawyer', 'criminal defense', 'estate planning', 'bankruptcy attorney', 'DUI lawyer', 'workers comp attorney', 'notary public', 'divorce attorney', 'real estate lawyer', 'business attorney', 'traffic ticket lawyer', 'employment lawyer'] },
  { id: 'education', label: 'Education', emoji: '📚', searches: ['tutoring center', 'driving school', 'music lessons', 'dance studio', 'martial arts', 'language school', 'daycare', 'preschool', 'art classes', 'cooking classes', 'swim school', 'SAT prep', 'coding bootcamp', 'after school program', 'montessori'] },
  { id: 'gaming', label: 'Gaming', emoji: '🎮', searches: ['gaming lounge', 'internet cafe', 'retro game store', 'tabletop game shop', 'esports venue', 'comic book store', 'card game shop', 'VR arcade', 'gaming PC builder', 'board game cafe', 'laser tag', 'escape room', 'arcade', 'bowling alley', 'mini golf'] },
  { id: 'lifestyle', label: 'Lifestyle', emoji: '✨', searches: ['tattoo shop', 'photography studio', 'florist', 'wedding planner', 'event planner', 'interior designer', 'life coach', 'travel agent', 'nutrition coach', 'meditation center'] },
];
